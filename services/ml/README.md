...
The current entrypoint builds the first usable synthetic dataset pipeline aligned with `schema_v1.1`.
...
4. Validates generated tables against `packages/contracts/schema_versions/schema_v1.1.yaml`.
5. Writes outputs and prints a concise summary.
