...
- `schema_v1.2.yaml`: methodological correction update — recalibrated risk thresholds, decoupled ML targets from heuristic labels, added missing-data indicator fields.

## Active Baseline

The current implementation baseline is `schema_v1.2.yaml`. New generator, validation, and downstream ML work should target that contract unless a later version is explicitly introduced.
