    ...
    <>
      <section className="section">
        ...
        <article className="panel">
          <h3>Real data, an imperfect real model</h3>
          <p>
      ...
      <section className="section">
        ...
        <article className="panel panel--caveat">
          <h3>Predicted weighted score is partially circular</h3>
          <p>
          ...
          <h3>Twin/feature value is mixed-to-null on real data</h3>
          <p>
      ...
      <section className="section">
        ...
        <article className="panel panel--caveat">
          <p>
            Explanations describe <strong>model behavior, not causal effects</strong>. They tell you
            which features moved this model&apos;s output, not what would happen if a student changed
            their behavior.
          </p>
          <ul>
            <li>
