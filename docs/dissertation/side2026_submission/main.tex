...
% Blind review: no author names, affiliations, acknowledgements or repository
% URL appear anywhere. Replace the anonymised repository line after acceptance.
%
...
\IEEEauthorblockA{Paper ID: (assigned by CMT)}}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.78\textwidth]{fig1_explanation_instability.pdf}
