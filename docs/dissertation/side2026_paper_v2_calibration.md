...
*ARCHIVED 2026-09-06. Version 2, built around a calibration claim that round-2 review showed to be an averaging artifact, and written before the zero-training baseline of exp_021 was computed. Kept for provenance only. Current draft: side2026_paper.md.*
