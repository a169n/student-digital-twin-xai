%% ============================================================================
%% SUPERSEDED (2026-07-26). This LaTeX source predates the submitted version and
%% the reviewer-driven revision that followed it. The authoritative artifact is
%% ../../IEEE_Talgatov.docx (revision 2); ./conference_paper_sist.md is generated
%% from it. Do not compile this file expecting the current paper -- it still has
%% the two-service architecture description, seven figures, and the old section
%% numbering. Kept only for history.
%% ============================================================================
