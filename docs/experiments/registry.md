...
| exp_026_gate_calibration | Global vs cohort-calibrated explanation gate (practice week 1) | completed | five-institution benchmark, 7 canonical features | post-processing of exp_025 and exp_027 students.csv | passed (classification only) | [exp_026_gate_calibration](../../data/artifacts/experiments/exp_026_gate_calibration) | [exp_026_gate_calibration.md](exp_026_gate_calibration.md) | Cohort calibration adds nothing over one global threshold (t must be read off the curve per configuration); the 0.23–0.57 institution spread is not invariant to the second method (0.36–0.43 against LIME). |
| exp_027_local_estimator_matrix | Local agreement matrix: TreeSHAP, occlusion, LIME + KernelSHAP control (practice week 2) | completed | five-institution benchmark, 7 canonical features | 63 cohorts, 11,875 students, f33 | passed (classification only) | [exp_027_local_estimator_matrix](../../data/artifacts/experiments/exp_027_local_estimator_matrix) | [exp_027_local_estimator_matrix.md](exp_027_local_estimator_matrix.md) | Across background draws every pair (τ-b 0.14–0.41) sits far below self-agreement (0.57–0.80); under model refits the diagonal falls to the cross level. Occlusion ties and output space explain little. |
| exp_028_local_sensitivity | Sensitivity of weeks 1–2 conclusions to cutoff (0.25/0.33/0.50) and model family (GBM/LR/RF) (practice week 3) | completed | five-institution benchmark, 7 canonical features | 9 configs × 63 cohorts × 11,875 students | passed (classification only) | [exp_028_local_sensitivity](../../data/artifacts/experiments/exp_028_local_sensitivity) | [exp_028_local_sensitivity.md](exp_028_local_sensitivity.md) | Occlusion–LIME lowest (C2), tie control (C3) and the gate's within-institution signal (C5) hold in all 9 configs, output-space control (C4) in all 6 evaluable; cross < self (C1) holds for tree ensembles only; calibration vs global and the LIME spread collapse depend on the configuration. |
