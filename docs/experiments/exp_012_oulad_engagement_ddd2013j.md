# exp_012_oulad_engagement_ddd2013j: Matched engagement-only PASSED classification on OULAD (DDD 2013J)
...
Run the engagement-only PASSED classification benchmark on OULAD (DDD 2013J) under a design MATCHED to the KU Leuven engagement benchmark (exp_011), so the two institutions can be compared head-to-head. Only binary PASSED classification is reported; OULAD's assessment-derived score is deliberately NOT used. Permutation importance identifies WHICH engagement features drive PASSED prediction so the cross-institution importance RANKS can be compared. final_grade is set to float(passed) purely as a structural placeholder for the shared pipeline; no real grade is used and no regression metric is reported.
...
- Experiment config: `services/ml/configs/experiments/exp_012_oulad_engagement_ddd2013j.yaml`
- Raw dir: `datasets/oulad`
- Course filter: code_module=DDD, code_presentation=2013J
- Snapshot rows: 67830
- Students: 1938
- Weeks: 4–38
- PASSED rate (student-level): 0.4278
- n_passed: 829, n_failed: 1109
...
| --- | --- | --- | ---: | ---: | ---: |
| temporal_forward | A_simple_engagement_oulad | logistic_regression | 0.804 | 0.798 | 0.910 |
| temporal_forward | B_engagement_oulad | logistic_regression | 0.793 | 0.828 | 0.916 |
| student_group | A_simple_engagement_oulad | gradient_boosting | 0.734 | 0.766 | 0.860 |
| student_group | B_engagement_oulad | gradient_boosting | 0.806 | 0.820 | 0.900 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| temporal_forward | A_simple_engagement_oulad | 0.790 | 0.774 | 0.893 | +0.000 | +0.000 |
| temporal_forward | B_engagement_oulad | 0.789 | 0.826 | 0.914 | -0.000 | +0.021 |
| student_group | A_simple_engagement_oulad | 0.734 | 0.766 | 0.860 | +0.000 | +0.000 |
| student_group | B_engagement_oulad | 0.806 | 0.820 | 0.900 | +0.072 | +0.040 |
...
- Total positive importance sum: 0.438108
- Top-1 feature share: 59.4%
- Top-3 feature share: 90.6%

| rank | feature | mean importance | std | share of positive |
| ---: | --- | ---: | ---: | ---: |
| 1 | cumulative_active_days_to_date | 0.2603 | 0.0019 | 59.4% |
| 2 | current_week_clicks | 0.0895 | 0.0014 | 20.4% |
| 3 | cumulative_clicks_to_date | 0.0470 | 0.0021 | 10.7% |
| 4 | cumulative_social_clicks_to_date | 0.0292 | 0.0013 | 6.7% |
| 5 | week_number | 0.0073 | 0.0005 | 1.7% |
| 6 | cumulative_content_clicks_to_date | 0.0042 | 0.0005 | 0.9% |
| 7 | content_click_ratio_to_date | 0.0005 | 0.0004 | 0.1% |
| 8 | has_vle_activity_to_date | 0.0000 | 0.0000 | 0.0% |

### Split: `temporal_forward`

- Total positive importance sum: 0.373691
- Top-1 feature share: 46.0%
- Top-3 feature share: 93.7%

| rank | feature | mean importance | std | share of positive |
| ---: | --- | ---: | ---: | ---: |
| 1 | cumulative_active_days_to_date | 0.1719 | 0.0030 | 46.0% |
| 2 | current_week_clicks | 0.1338 | 0.0046 | 35.8% |
| 3 | cumulative_clicks_to_date | 0.0444 | 0.0027 | 11.9% |
| 4 | cumulative_content_clicks_to_date | 0.0146 | 0.0014 | 3.9% |
| 5 | cumulative_social_clicks_to_date | 0.0090 | 0.0011 | 2.4% |
| 6 | has_vle_activity_to_date | 0.0000 | 0.0000 | 0.0% |
| 7 | week_number | 0.0000 | 0.0000 | 0.0% |
| 8 | content_click_ratio_to_date | -0.0017 | 0.0006 | 0.0% |

## Interpretation

Richer engagement features provide negligible additional F1 lift over the minimal baseline on OULAD. The dominant PASSED signal is already captured by cumulative clicks and active days; the additional features do not materially shift classification accuracy.

- Outcome: `engagement_richness_neutral`
- Primary delta F1: `-0.000`
- Short conclusion: `B_engagement_oulad` was approximately level with `A_simple_engagement_oulad` (delta F1 = -0.000).

## Artifact paths

- Results JSON: `data/artifacts/experiments/exp_012_oulad_engagement_ddd2013j/exp_012_oulad_engagement_ddd2013j_results.json`
- Results CSV: `data/artifacts/experiments/exp_012_oulad_engagement_ddd2013j/exp_012_oulad_engagement_ddd2013j_results.csv`
- Importance CSV: `data/artifacts/experiments/exp_012_oulad_engagement_ddd2013j/engagement_importance.csv`
